    ...
    <div className="min-h-screen">
      ...
      <header className="border-b border-white/5 px-6 py-4">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-white text-sm">Base2.0</h1>
        ...
        {!isConnected ? (
          ...
          <div className="text-center py-16 space-y-6">
            ...
            <p className="text-gray-400 max-w-md mx-auto">
              Every wallet on Base2.0 has a built-in private sub-account.
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-xs text-gray-600">
                Connect MetaMask to Base2.0 Devnet (Chain ID: 845311 · RPC: localhost:8545)
              </p>
            </div>
      ...
      <footer className="border-t border-white/5 px-6 py-4 mt-8">
        <div className="max-w-3xl mx-auto flex items-center justify-between text-xs text-gray-600">
          <span>Base2.0 — forked from <span className="text-gray-500">base/op-geth</span> &amp; <span className="text-gray-500">base/optimism</span></span>
