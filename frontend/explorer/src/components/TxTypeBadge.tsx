...
const BADGE_CONFIG: Record<TxType, { label: string; color: string; icon: string }> = {
  ...
  shielded:  { label: 'Shielded',     color: 'bg-private-500/15 text-private-400 border-private-500/20',   icon: '🛡️' },
  ...
  system:    { label: 'System',       color: 'bg-gray-500/15 text-gray-500 border-gray-500/20',           icon: '⚙️' },
};
