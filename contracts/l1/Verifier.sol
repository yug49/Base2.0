...
// Verifier: stores verification keys per (nullifiers, commitments) and
// verifies Groth16 SNARK proofs for shielded transactions.
// ============================================================================
...
contract Verifier is OwnableUpgradeable {
    ...
    /// @dev Nullifiers => Commitments => Verification Key
