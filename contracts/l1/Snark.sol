...
// Groth16 BN254 pairing-based proof verification library
// Uses EVM precompiles: ecAdd (0x06), ecMul (0x07), ecPairing (0x08)
// ============================================================================

import {G1Point, G2Point, VerifyingKey, SnarkProof, SNARK_SCALAR_FIELD} from "../shared/Globals.sol";
